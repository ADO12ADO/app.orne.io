...
export function Wallet() {
	...
	return (
		<div className="flex gap-4 rounded-full bg-white p-1 pl-3 shadow-sm">
			...
			{/*		</div>*/}
			{/*	) : (*/}
			{/*		<span>{readAmount(orneBalance.data?.balance, { decimals: 6, comma: true, fixed: 3 })}</span>*/}
			{/*	)}*/}
			...
			<Popover title="My Wallet" closable trigger={<Button size="sm">My Wallet</Button>}>
				<div className="my-6 flex flex-col justify-between border-b border-beige pb-6">
					...
					{orneBalance.isLoading ? (
						...
						<p className="text-2xl font-semibold">
							{readAmount(orneBalance.data?.balance, { decimals: 6, comma: true, fixed: 3 })}{' '}
